...
class UICollectionViewFlowLayoutViewController2: BaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        title = "UICollectionViewFlowLayout-设置cell大小"
...
extension UICollectionViewFlowLayoutViewController2: UICollectionViewDataSource {
...
// UICollectionViewDelegateFlowLayout 继承于 UICollectionViewDelegate
extension UICollectionViewFlowLayoutViewController2: UICollectionViewDelegateFlowLayout {
    // item被选中时，回调
